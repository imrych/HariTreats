...
INSERT INTO `orders` (`id`, `name`, `address`, `mobile`, `email`, `status`, 'payment_method') VALUES
(1, 'James Smith', 'adasdasd asdadasd', '4756463215', 'jsmith@sample.com', 1,'Gcash'),
(2, 'James Smith', 'adasdasd asdadasd', '4756463215', 'jsmith@sample.com', 1, 'Cash on Delivery');
...
VALUES  (1, 'James', 'Smith', 'jsmith@sample.com', '1234', '4756463215', 'adasdasd asdadasd');
...
--
ALTER TABLE `orders` ADD `date` DATE NOT NULL AFTER `payment_method`;
ALTER TABLE `users`
  MODIFY `id` int(30) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
